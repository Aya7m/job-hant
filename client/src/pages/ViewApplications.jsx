...
const ViewApplications = () => {
  return (
    <div className="container p-4 mx-auto">
      <div>
        <table className="w-full max-w-4xl border border-gray-100 max-sm:text-sm">
          <thead>
          ...
          <tbody>
            {viewApplicationsPageData.map((application, index) => (
              <tr key={index} className="text-gray-700">
                ...
                <td className="px-4 py-2 border-b text-center max-sm:hidden">
                ...
                <td className="px-4 py-2 border-b text-center">
                  <a
                    href=""
                    target="_blank"
                    className="bg-red-50 text-blue-500 px-3 py-1 rounded inline-flex gap-2 items-center"
                  >
                ...
                <td className="px-4 py-2 border-b relative text-center">
                  <div className="relative group inline-block">
                    ...
                    <div className="z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-blue-300 rounded shadow group-hover:block">
